...
//        {
//            Type type = typeof(ActsCP1);
//            ActsCP1 ClassObject = new ActsCP1();
...
//        GameManager.Instance.cp1ProtectedFromInvasiveAnimal = true;
//    }
...
//        {
//            if (deck.DeckId == GameManager.Instance.computerOneDeck) //checks to make sure that the players deck is the one that is being used
//            {
...
//                for (int j = 0; j < GameManager.Instance.DiscardPlacementCP1.Count; j++) //this will bes used to check the discard pile and see if there are any animals in it
//                {
//                    if (GameManager.Instance.DiscardPlacementCP1[j].CardType == "Animal")
//                    {
//                        GameManager.Instance.DiscardSelectionList.Add(GameManager.Instance.DiscardPlacementCP1[j]); //if an animal, adds to the discard selection list
//                    }
//                }
...
//                    for (int i = 0; i < GameManager.Instance.DiscardPlacementCP1.Count; i++) //goes through the discard pile, finds the card, then removes it from the deck list
//                    {
//                        if (GameManager.Instance.DiscardPlacementCP1[i].CardName == cardHolder.CardName)
//                        {
//                            GameManager.Instance.DiscardPlacementCP1.Remove(cardHolder); //removes the card
//                            break; //just breaks the for loop
//                        }
//                    }
//                }
...
//        GameManager.Instance.cp1ProtectedFromInvasivePlant = true;
//    }
...
//                for (int j = 0; j < GameManager.Instance.DiscardPlacementCP1.Count; j++) //this will bes used to check the discard pile and see if there are any animals in it
//                {
//                    if (GameManager.Instance.DiscardPlacementCP1[j].CardType == "Plant")
//                    {
//                        GameManager.Instance.DiscardSelectionList.Add(GameManager.Instance.DiscardPlacementCP1[j]); //if an animal, adds to the discard selection list
//                    }
//                }
...
//                    GameManager.Instance.PlantPlacementCP1.Add(cardHolder); //adds the selected card to the animal placement list
...
//        GameManager.Instance.cp1NoConditionRequirements = true;
//    }
...
//                for (int j = 0; j < GameManager.Instance.DiscardPlacementCP1.Count; j++) //this will bes used to check the discard pile and see if there are any animals in it
//                {
//                    if (GameManager.Instance.DiscardPlacementCP1[j].CardType == "Condition")
//                    {
//                        GameManager.Instance.DiscardSelectionList.Add(GameManager.Instance.DiscardPlacementCP1[j]); //if an animal, adds to the discard selection list
//                    }
//                }
...
//                    GameManager.Instance.ConditionPlacementCP1.Add(cardHolder); //adds the selected card to the animal placement list
...
//    {
//        GameManager.Instance.cp1ProtectedFromBlight = true;
//    }
...
//    {
//        //GameManager.Instance.cp1ProtectedFromExtinction = true; //player will be protected from exitinction while this is true
//    }
...
//    {
//        GameManager.Instance.cp1PausedOneTurn = true; //this will make it so that the players actions will be paused for one round
//    }
...
//    {
//        GameManager.Instance.cp1ProtectedFromWeb = true; //protects the player from the web of life and other standing actions cards
//    }
...
//        GameManager.Instance.cp1PausedOneTurn = true; //will make it so it pauses
//    }

//    //Human - Grandma Moore
//    public void a016() //Standing Action: When Grandma Moore is in play, you no longer need to discard at the end of your turn
//    {
//        GameManager.Instance.cp1NoDiscard = true; //player no longer has to discard
//    }
...
//    {
//        GameManager.Instance.cp1DrawExtraCard = true; //player can now draw an extra card at the beginning of the round
//    }
...
//    {
//        GameManager.Instance.cp1TwentyPointNoDiscard = true; //player can keep one twenty point card in their hand 
//    }
...
//    {
//        GameManager.Instance.cp1ProtectedFromInvertebrate = true; //player is protected from invaive invertebrate
//    }
...
//                for (int j = 0; j < GameManager.Instance.DiscardPlacementCP1.Count; j++) //this will bes used to check the discard pile and see if there are any animals in it
//                {
//                    if (GameManager.Instance.DiscardPlacementCP1[j].CardType == "Invertebrate")
//                    {
//                        GameManager.Instance.DiscardSelectionList.Add(GameManager.Instance.DiscardPlacementCP1[j]); //if an animal, adds to the discard selection list
//                    }
//                }
...
//                    GameManager.Instance.InvertebratePlacementCP1.Add(cardHolder); //adds the selected card to the animal placement list
...
//                for (int j = 0; j < GameManager.Instance.DiscardPlacementCP1.Count; j++) //this will bes used to check the discard pile and see if there are any animals in it
//                {
//                    if (GameManager.Instance.DiscardPlacementCP1[j].PlantType == "Canopy" || GameManager.Instance.DiscardPlacementCP1[j].PlantType == "Understory")
//                    {
...
//                for (int j = 0; j < GameManager.Instance.DiscardPlacementCP1.Count; j++) //this will bes used to check the discard pile and see if there are any animals in it
//                {
//                    if (GameManager.Instance.DiscardPlacementCP1[j].AnimalDiet == "Herbivore")
//                    {
//                        GameManager.Instance.DiscardSelectionList.Add(GameManager.Instance.DiscardPlacement[j]); //if an animal, adds to the discard selection list
//                    }
//                }
...
//    {
//        for (int i = 0; i < GameManager.Instance.MicrobePlacementCP1.Count; i++) //goes through the microbe placement list
//        {
//            if (GameManager.Instance.MicrobePlacementCP1[i].CardName == "Microbe-Spirulina-Algae") //if the correct card is here, sets the plant type to groundcover
//                GameManager.Instance.MicrobePlacementCP1[i].PlantType = "Groundcover";
//        }
//    }
