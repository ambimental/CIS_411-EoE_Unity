...
public class PickDeck : MonoBehaviour
{
    ...
    private Color32 appalachianColor = new Color32(166, 135, 82, 128);
    private Color32 alleghenyColor = new Color32(58, 102, 44, 128);
    private Color32 clarionRiverColor = new Color32(116, 126, 140, 128);
    private Color32 peatBogsColor = new Color32(124, 56, 58, 128);
